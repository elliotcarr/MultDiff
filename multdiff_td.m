...
%   (l(i-1) < x < l(i)):
%
%      du_(i)/dt = d/dx * (D(i) * du_(i)/dx),   i = 1,...,m,
%   
...
%
%   where u_(i) is the solution in layer i, D(i) is the diffusivity in 
...
%    - Perfect contact 
%       u_(i)(x,t) = u_(i+1)(x,t)                           
%       D(i) * u_(i)(x,t) = D(i+1) * u_(i+1)(x,t)
%
%    - Imperfect contact
%       D(i) * du_(i)/dx(x,t) = H(i) * (u_(i+1)(x,t) - u_(i)(x,t))
%       D(i+1) * du_(i+1)/dx(x,t) = H(i) * (u_(i+1)(x,t) - u_(i)(x,t))       
%   
%   Usage:
%   -----------------------------------------------------------------------
%   [U,X] = multdiff(m,D,l0,lM,l,u0,bcs,tspan,'Perfect')
%   [U,X] = multdiff(m,D,l0,lM,l,u0,bcs,tspan,'Perfect',options)
%   [U,X] = multdiff(m,D,l0,lM,l,u0,bcs,tspan,'Imperfect',H)
%   [U,X] = multdiff(m,D,l0,lM,l,u0,bcs,tspan,'Imperfect',H,options)
%
%   Input Arguments:
%   -----------------------------------------------------------------------
%   m           Number of layers. Must be an integer greater than or equal 
%               to 3.  
%   D       A vector of length M containing the diffusivity values 
